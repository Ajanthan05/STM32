...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PA10     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(TWI0_SCL_GPIO_Port, TWI0_SCL_Pin);

    HAL_GPIO_DeInit(TWI0_SDA_GPIO_Port, TWI0_SDA_Pin);
  ...
  else if(hi2c->Instance==I2C2)
  {
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(TWI1_SCL_GPIO_Port, TWI1_SCL_Pin);

    HAL_GPIO_DeInit(TWI1_SDA_GPIO_Port, TWI1_SDA_Pin);
